...
public class UVCCamera {
	...
	public static final int PIXEL_FORMAT_GREYLEOPARD = 7;
...
//================================================================================
	...
	private static final native int nativeSetPreviewSizeFPS(long id_camera, int width, int height, int mode, int minfps, int maxfps);
